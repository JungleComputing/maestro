...
props='ibis.maestro.terminatorStartQuotum=0.1,ibis.maestro.terminatorInitialSleepTime=2000,ibis.maestro.terminatorSleepTime=2000,ibis.maestro.terminatorNodeQuotum=' + frac
...
$label.application.output.files = termination-$arg-fs0.das3.cs.vu.nl.logs
