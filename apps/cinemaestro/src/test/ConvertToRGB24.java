...
public class ConvertToRGB24 {
    ...
    private ConvertToRGB24(FileInfo [] in, FilesetDescription out, int w, int h) { 
        this.in = in;
        this.out = out;     
        this.width = w;
        this.height= h;
    ...
    private void start() {
        ...
        try { 
            ...
            ToRGB24 extender = new ToRGB24(number++, "Extender", scaled, uncompressedOut, null);  
    ...
    public static void main(String [] args) throws Exception {
        ...
        new ConvertToRGB24(in, fsOut, width, height).start();        
    }
}
