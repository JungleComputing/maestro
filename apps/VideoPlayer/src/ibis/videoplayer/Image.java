...
abstract class Image implements Serializable {
    ...
    /**
     * Given a file name, load that file, and create an image. The type of image
     * is determined by the file extension of the filename. At the moment only
     * files ending with '.png' are supported, and create an uncompressed image.
     * 
     * @param f
     *            The file to load.
     * @param frameno
     ...
     * @throws IOException
     *             Thrown if the image cannot be read.
     */
