...
/**
 * Build the frames for a video sequence. Requires the 'convert' command from
 * imagemagick.
 * 
...
class MakeFramesProgram {
    ...
    public static void main(String[] args) {
        for (int frame = 0; frame < FRAMES; frame++) {
            ...
            String command = "convert -depth 16 +compress -size "
                    + WIDTH
                    + 'x'
                    + HEIGHT
                    + " xc:"
                    + BACKGROUND_COLOR
                    + " -fill white -stroke black -draw \"stroke-width 10 stroke-linecap round line "
